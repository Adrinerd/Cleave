...
1. Uno pulsa **Online → Crear partida**, pone su nombre y le sale un código de 4 letras.
...
4. En cuanto los dos estáis dentro, pasáis solos a la pantalla del reparto.
5. Cada uno reparte sus valores. **La partida arranca sola cuando los dos terminéis** — no hay botón de empezar.

Mientras esperas ves si el otro ya ha terminado o sigue repartiendo.
...
**Solo uno de los dos abre la sala.** Si los dos pulsáis *Abrir una sala*, cada uno crea la suya con un código distinto y os quedáis esperando para siempre, los dos viendo la misma pantalla. Uno abre, el otro entra con el enlace.

Si por lo que sea acabáis los dos con el mismo código creyendo que sois el anfitrión, la app lo detecta y reparte los papeles sola.
