...
self.addEventListener('fetch', e => {
  ...
  // La librería de red y los relés NUNCA se cachean: el online necesita red
  // de todas formas, y una copia vieja rompe las salas.
  if (/mqtt|unpkg\.com|jsdelivr\.net|emqx|hivemq|mosquitto/i.test(url)) {
